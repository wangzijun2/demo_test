...
class CreateProtocolItem:
    ...
    def save_supply_hdr(self):
        ...
        head_sub_unit_num_id = input("请输入采购总部门店编号：")
        supply_param_dict["head_sub_unit_num_id"] = head_sub_unit_num_id
    ...
    def save_supply_dtl(self):
        ...
        while count <= int(max_count):
            ...
            # 是否设置为b2b销售商品
            is_b2b = input("是否设置该商品为b2b商品:（1:表示设置，0:标识不设置）")
            protocol_dtl_info_dict['save_bl_protocol_dtl_list'][0]['is_b2b'] = is_b2b
